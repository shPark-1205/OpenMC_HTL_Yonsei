# Run_Simulation_CSG.py

import sys
import os
import yaml

from GUI_CSG import StatusWindow, SourceSelectionWindow
from Simulation_Builder_CSG import NuclearFusion
...
def main():
    ...
    try:
        ...
        # 설정 파일(yaml) 불러오기
        print("--- Loading configuration from config_CSG.yaml file ---")
