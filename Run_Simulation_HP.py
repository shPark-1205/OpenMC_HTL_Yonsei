# Run_Simulation_HP.py

import sys
import os
import yaml

from GUI_HP import StatusWindow, SourceSelectionWindow
from Simulation_Builder_HP import NuclearFusion
...
def main():
    ...
    try:
        ...
        with open('config_HP.yaml', 'r') as f:
