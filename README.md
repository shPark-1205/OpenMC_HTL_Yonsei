#### Original OpenMC software developed by
...
5. Verify that OpenMC and all imported packages are functioning correctly.
6. Fow Windows users, install VcXsrv from https://vcxsrv.com/ for plotting and visulization.
7. Enjoy your simulation.
